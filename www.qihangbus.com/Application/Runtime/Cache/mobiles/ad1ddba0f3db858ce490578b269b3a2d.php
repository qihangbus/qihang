...
<form name="myform" id="myform" action="<?php echo U('mobile.php/Ucenter/edit_address');?>" method="post" onsubmit="return check(this);">
...
$(document).ready(function(){
	$("#province").change(function(){
		...
		$.post("<?php echo U('mobile.php/Ucenter/ajax_address');?>",{region_id:region_id,region_level:2},function(result){
	...
	$("#city").change(function(){
		var region_id = $(this).val();
		$.post("<?php echo U('mobile.php/Ucenter/ajax_address');?>",{region_id:region_id,region_level:3},function(result){
			$("#district")[0].options.length = 0;
			$("#district")[0].options.add(new Option("请选择",""));
			for (var i = 0; i < result.length; i++) {	
				var date = result[i];
