...
<dl class="dl_up js_uploadBox">
    <form name="myform" id="myform" enctype="multipart/form-data" method="post" action="<?php echo U('mobile.php/Ucenter/update_avatar');?>">
	<input type="hidden" name="user_id" value="<?php echo ($user_id); ?>">
	<input type="hidden" name="user_flag" value="3">
