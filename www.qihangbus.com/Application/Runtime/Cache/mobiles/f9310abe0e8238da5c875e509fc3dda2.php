...
<header class="demo-header">
	...
	<div class="a_menu">
	 <ul>
		<li><a href="<?php echo U('mobile.php/MIndex/select_user',array('user_id'=>$user_id,'school_id'=>$userinfo['school_id'],'type'=>1));?>"><span>教师</span></a></li>
		<li><a href="<?php echo U('mobile.php/MIndex/select_user',array('user_id'=>$user_id,'school_id'=>$userinfo['school_id'],'type'=>2));?>"><span>学生</span></a></li>
	 </ul>
	 </div>
