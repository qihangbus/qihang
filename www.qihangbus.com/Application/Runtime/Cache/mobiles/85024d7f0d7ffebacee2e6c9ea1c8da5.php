...
<body>
    <div class="wrap2 have-bottom-swiper">
        <div class="yuanzhang_t">
            <div class="head-top"><?php echo ($info["school_name"]); ?></div>
            <dl>
                <dt>
                    <a href="<?php echo U('mobile.php/MIndex/avatar',array('user_id'=>$info['admin_id']));?>">
                    <img src="<?php echo ((isset($info["admin_avatar"]) && ($info["admin_avatar"] !== ""))?($info["admin_avatar"]):'/Public/images/mobiles/default.png'); ?>" alt="background_image" />
                    </a>
                </dt>    
                <dd>
                <div class="qiandao-div">
                    <?php if($signin < '0'): ?><div class="d_signin" id="signin" uid="<?php echo ($id); ?>"><span class="iconfont icon-qiandao"></span></div>
                    <?php else: ?>
    ...
    <ul class="ul_2">
        ...
        <li><a href="<?php echo U('mobile.php/Book/index',array('user_id'=>$id,'user_points'=>$userinfo['rank_points'],'user_flag'=>4));?>">
            <span class="iconfont icon-duihuan"></span>
            <span class="head-cate-txt">兑换中心</span>
            </a>
        </li>
        <li class=""><a href="<?php echo U('mobile.php/MIndex/setting',array('user_id'=>$id,'user_flag'=>4));?>">
            <span class="iconfont icon-shezhi"></span>
            <span class="head-cate-txt">设置</span>
        </a></li>
    </ul></div>
        <ul class="m_menu clearfix">
            <li class="li_item">
            <a href="<?php echo U('mobile.php/MIndex/circul',array('id'=>$id,'t'=>1));?>">
                <span class="iconfont icon-huan"></span>
                <span class="m_menu-txt">轮换管理</span>
            </a>
            </li>
            <li class="li_item">
            <a href="<?php echo U('mobile.php/MIndex/books',array('id'=>$id,'t'=>2));?>">
                <span class="iconfont icon-tushu"></span>
                <span class="m_menu-txt">图书管理</span>
            </a>
            </li>
            <li class="li_item ">
                <a href="<?php echo U('reissue');?>">
                    <span class="fa fa-sign-in" style="font-size:39px;margin-top: 3px;color:#65c7dc"></span>
                    <span class="m_menu-txt">补发接收</span>
                </a>
            </li>

            <li class="li_item">
            <a href="mobile.php?m=mobile.php&c=Student&a=index&id=<?php echo ($info["school_id"]); ?>&user_flag=4&admin_id=<?php echo ($info["admin_id"]); ?>">
                <span class="iconfont icon-xuesheng"></span>
                <span class="m_menu-txt">学生信息</span>
            </a>
            </li>
            <li class="li_item">
            <a href="<?php echo U('Datainfo/index',array('admin_id'=>$info['admin_id'],'id'=>$info['school_id'],'user_flag'=>4));?>">
            ...
            <li class="li_item <?php if($userinfo["message_num"] > '0'): ?>li_item_p<?php endif; ?>">
                <a href="<?php echo U('mobile.php/MIndex/get_message_list',array('user_id'=>$id,'user_flag'=>4));?>">
        ...
        <!--
            <li class="li_item">
                <a href="<?php echo U('mobile.php/Cart/index',array('user_id'=>$id,'user_flag'=>4));?>">
            ...
            <li class="li_item">
            <a href="mobile.php?m=mobile.php&c=Order&a=index&user_id=<?php echo ($id); ?>&user_flag=4">
...
$(function(){
    ...
    $("#signin").click(function(){
        ...
        var num = $("#signnum").val();
        var uflag = 4;
        $.post("<?php echo U('mobile.php/MIndex/signin');?>",{user_id:uid,user_flag:uflag,signnum:num},function(ret){
            if(ret.code > 0){
