...
<dl class="dl_up js_uploadBox">
    <form name="myform" id="myform" enctype="multipart/form-data" method="post" action="<?php echo U('mobile.php/TIndex/update_avatar');?>">    
	<input type="button" name="user_id" value="<?php echo ($user_id); ?>">
	<input type="button" name="user_flag" value="2">
    <input type="button" name="avatar_old" value="<?php echo ($avatar); ?>">
	<dt><span class="js_showBox "><img class="js_logoBox" id="avatar" src="<?php echo ($avatar); ?>" width="100px" ></span></dt>
