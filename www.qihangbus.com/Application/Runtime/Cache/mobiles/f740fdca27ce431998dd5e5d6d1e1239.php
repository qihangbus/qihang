...
<header class="demo-header">
 ...
 <div class="a_menu">
 <ul>
 	<li><a href="<?php echo U('mobile.php/TIndex/select_user',array('user_id'=>$user_id,'class_id'=>$userinfo['class_id'],'type'=>1));?>"><span>教师</span></a></li>
 	<li><a href="<?php echo U('mobile.php/TIndex/select_user',array('user_id'=>$user_id,'class_id'=>$userinfo['class_id'],'type'=>2));?>"><span>学生</span></a></li>
 </ul>
 </div>
<div class="wrap2"> 
...
{
	$.post("<?php echo U('mobile.php/TIndex/ajax_message');?>",{message_id:mid},function(result){
			if(result > 0){
