            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="li_cart" style="margin-bottom:0px;padding-top:10px;">
                    <dl class="cart_pro">
                        ...
                        <dd class="dd_pname2 p_padr">
                            ...
                            <p class=""><b>订购 </b><?php echo ($semester); ?></p>
                        </dd>
                        <dd class="dd_r" style="padding-top:20px">
                            <a href="<?php echo U('mobile.php/TClass/readhistory',array('student_id'=>$vo['student_id'],'teacher_id'=>$teacher_id,'readbook'=>$readbook));?>" class="ibtn_1">借阅历史</a>
                        </dd>
                    </dl>
