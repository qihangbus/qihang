...
<div class="iban"><img src="/Public/images/mobiles/ban_mx.jpg" alt="" /></div>
	<div class="mxjilu_t">
		<span class="iconfont icon-dadou"></span>当前可用金豆<b class="color2"><?php echo ($gold); ?></b>颗<a href="<?php echo U('mobile.php/MIndex/earn_log',array('user_id'=>$user_id,'user_flag'=>$user_flag));?>" class="ibtn_1">收益记录</a>
	</div>
