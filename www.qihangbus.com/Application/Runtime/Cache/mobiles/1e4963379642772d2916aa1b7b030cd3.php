...
<div class="wrap2"> 
	<ul class="m_setting ">
		<a href="<?php echo U('mobile.php/MIndex/address/',array('user_id'=>$user_id,'user_flag'=>$user_flag));?>">
		...
		<a href="<?php echo U('mobile.php/MIndex/earn/',array('user_id'=>$user_id,'user_flag'=>$user_flag));?>">
		...
		<a href="<?php echo U('mobile.php/MIndex/teacher/',array('user_id'=>$user_id,'user_flag'=>$user_flag));?>">
			<li class="li_item"><i class="fa fa-user" style="color:#b4de86;font-size:24px;padding:11px;width:40px;"></i><span style="padding-left:0px;">教师管理</span></li>
		</a>

		<a href="<?php echo U('mobile.php/MIndex/editPwd');?>">
		...
		<a href="<?php echo U('mobile.php/MIndex/signOut',array('user_id'=>$user_id,'user_flag'=>$user_flag));?>">
