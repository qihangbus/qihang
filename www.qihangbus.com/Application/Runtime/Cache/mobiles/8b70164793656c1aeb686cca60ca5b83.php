...
<form name="myform" id="myform" action="<?php echo U('mobile.php/TIndex/message_handle');?>" method="post">
<input type="hidden" name="user_id" value="<?php echo ($user_id); ?>"/>
<input type="hidden" name="receive_id" value="<?php echo ($receive_id); ?>"/>	
<input type="hidden" name="t" value="<?php echo ($type); ?>"/>	
	<dl class="pinglun_add" style="display:none;">
		<dt class="pl_tit"><span>标题</span></dt>
		<dd class="pl_textarea"><input type="text" name="title" style="border:none;width:100%;" placeholder="在这里输入消息标题"></dd>
	</dl>
	<div class="line_hr"></div>
	<dl class="pinglun_add">
		<dt class="pl_tit"><span>内容</span></dt>
		<dd class="pl_textarea"><textarea class="textarea" maxlength="100" placeholder="在这里输入消息内容" name="message"></textarea></dd>
	</dl>


<br><br><br>
	<div class="btn_box btn_boxadd"><a href="javascript:void(0);" class="btn btn2 btn_addjz">发送</a></div>
</form>
