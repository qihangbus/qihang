...
<head>
    ...
    <title>学生管理_<?php echo L('_WEBSITE_NAME_');?></title>
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <a href="javascript:void(0);" class="btn disabled">学生列表</a>
                                <a href="<?php echo U('/Student/add');?>" class="btn btn-primary">添加学生</a>
                                <a href="<?php echo U('/Student/import');?>" class="btn btn-primary">导入数据</a>
                             </span>
                        </header>
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" method="post" id="myform"  name="myform" action="<?php echo U('/Student/index');?>">
                                <div class="adv-table">
                                    ...
                                    <div class="span6">
                                        <div id="dynamic-table_filter" style="width:60%;" class="dataTables_filter">
                                            ...
                                            <label>
                                                ...
                                                学生名称:<input class="form-control" id="keywords" value="<?php echo ($keywords); ?>" name="keywords" aria-controls="dynamic-table" type="text">
                                            </label>
                                    ...
                                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-lg-2">学生名称</th>
                                            <th class="col-lg-2">学校</th>
                                            <th class="col-lg-1">年级</th>
                                            <th class="col-lg-1">班级</th>
                                            <th class="col-lg-3">管理操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                            ...
                                            <td>
                                                <a href='<?php echo U("/Student/parent/id/$vo[student_id]");?>' class="edit">家长信息</a> |
                                                <a href='<?php echo U("/Student/send/id/$vo[student_id]");?>' class="delete">发送消息</a> |
                                                <a href='<?php echo U("/Student/edit/id/$vo[student_id]");?>' class="edit">修改</a> |
                                                <?php if($vo['role_id'] == 1): ?><label class="delete">删除</label>
                                                    <?php else: ?>
                                                    <a href="javascript:confirmurl('<?php echo U("/Student/del",array('id'=>$vo['student_id']));?>', '是否删除?')" class="delete">删除</a><?php endif; ?>
                                            </td>
