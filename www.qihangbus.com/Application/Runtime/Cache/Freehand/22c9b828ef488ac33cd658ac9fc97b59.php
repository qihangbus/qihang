...
<head>
    ...
    <title>部门管理_<?php echo L('_WEBSITE_NAME_');?></title>
...
<!-- header section end-->
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="#"><?php if(empty($des)): ?>部门管理<?php else: echo ($des); endif; ?></a>
                </li>
            </ul>
        </div>
        <!-- page heading end-->
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <a href="javascript:void(0);" class="btn disabled">机构列表</a>
                                <a href="<?php echo U('/Schools/add');?>" class="btn btn-primary">添加机构</a>
                                <a href="<?php echo U('/Schools/import');?>" class="btn btn-primary">导入机构</a>
                                <a href="<?php echo U('/Schools/batch_send');?>" class="btn btn-primary">批量发送消息</a>
                             </span>
                        </header>
                                ...
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-lg-1">负责人</th>
                                            <th class="col-lg-1">园长姓名</th>
                                            <th class="col-lg-1">规模</th>
                                            <th class="col-lg-1">图书损耗量</th>
                                            <th class="col-lg-4">管理操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                                ...
                                                <td><?php echo ($vo['school_leader']); ?></td>
                                                <td><?php echo ($vo['school_teacher']); ?></td>
                                                <td><?php echo ($vo['school_num']); ?></td>
                                                <td><?php echo ($vo['book_lose_num']); ?></td>
                                                <td class="col-lg-3">
                                                    <a href="<?php echo U('/Schools/import_list/',array('id'=>$vo['school_id']));?>" class="delete">导出图书</a> |
                                                    <a href="<?php echo U('/Schools/book_list/',array('id'=>$vo['school_id']));?>" class="delete">图书管理</a> |
                                                    <a href='<?php echo U("/Schools/send/id/$vo[school_id]");?>' class="delete">发送消息</a> |
                                                    <a href="/default.php/Admin/School/index/school_id/<?php echo ($vo['school_id']); ?>" class="delete">补发图书</a> |
                                                    <a href='<?php echo U("/Schools/edit/id/$vo[school_id]");?>' class="edit">修改</a> |
                                                    <a href="javascript:confirmurl('<?php echo U("/Schools/del",array('id'=>$vo['school_id']));?>', '是否删除?')" class="delete">删除</a>
                                                </td>
