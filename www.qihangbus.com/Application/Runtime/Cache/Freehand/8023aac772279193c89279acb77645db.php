...
<head>
    ...
    <title>图书管理_<?php echo L('_WEBSITE_NAME_');?></title>
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <a href="javascript:void(0);" class="btn disabled">图书列表</a>
                                <a href="<?php echo U('/Books/add');?>" class="btn btn-primary">添加图书</a>
                                ...
                                <div class="adv-table">
                                    ...
                                    <div class="span6">
                                        <div id="dynamic-table_filter" style="width:60%;" class="dataTables_filter">
                                            ...
                                            <label>
                                                ...
                                                图书名称:<input class="form-control" id="keywords" value="<?php echo ($keywords); ?>" name="keywords" aria-controls="dynamic-table" type="text">
                                            </label>
                                    ...
                                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-lg-1">图书封面</th>
                                            <th class="col-lg-2">图书名称</th>
                                            <th class="col-lg-1">作者</th>
                                            <th class="col-lg-1">市场价</th>
											<th class="col-lg-1">本店价</th>
											<th class="col-lg-1">积分兑换价</th>
                                        ...
                                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                            ...
                                            <td><img src="<?php echo ($vo['book_thumb']); ?>" style="width:80px;"></td>
                                            <td>【<?php echo ($vo['book_name']); ?>】<?php echo ($vo['sub_name']); ?></td>
                                            <td><?php echo ($vo['book_author']); ?></td>
                                            <td><?php echo ($vo['market_price']); ?></td>
											<td><?php echo ($vo['shop_price']); ?></td>
											<td><?php echo ($vo['points_price']); ?></td>
                                            <td><?php echo ($vo['book_number']); ?></td>
											<td><?php echo ($vo['cate_name']); ?></td>
                                            <td>
                                                <a href='<?php echo U("/Books/edit/id/$vo[book_id]");?>' class="edit">修改</a>|<a href="javascript:confirmurl('<?php echo U('/Books/del',array('id'=>$vo['book_id']));?>', '是否删除?')" class="delete">删除</a>
                                            </td>
