...
<head>
    ...
    <title>兑换分类管理_<?php echo L('_WEBSITE_NAME_');?></title>
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                ...
                                <a href="<?php echo U('/productcate/add');?>" class="btn btn-primary">添加分类</a>
                             </span>
                        </header>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <a href='<?php echo U("/productcate/edit/id/$vo[cate_id]");?>' class="edit">修改</a> |
                                                <a href="javascript:confirmurl('<?php echo U("/productcate/del",array('id'=>$vo['cate_id']));?>', '是否删除?')" class="delete">删除</a>
                                            </td>
