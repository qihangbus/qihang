...
<head>
    ...
    <title>图书分类管理_<?php echo L('_WEBSITE_NAME_');?></title>
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <a href="javascript:void(0);" class="btn disabled">分类列表</a>
                                <a href="<?php echo U('/book_cate/add');?>" class="btn btn-primary">添加分类</a>
                             </span>
                        </header>
                                ...
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-lg-6">分类名称</th>
                                            <th class="col-lg-3">上级分类</th>
                                        ...
                                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                            ...
                                            <td>
                                                <a href='<?php echo U("/book_cate/edit/id/$vo[cate_id]");?>' class="edit">修改</a> |
                                                <a href="javascript:confirmurl('<?php echo U("/book_cate/del",array('id'=>$vo['cate_id']));?>', '是否删除?')" class="delete">删除</a>
                                            </td>
