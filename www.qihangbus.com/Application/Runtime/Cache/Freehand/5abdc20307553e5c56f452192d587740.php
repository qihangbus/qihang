...
<head>
  ...
  <title>广告列表_<?php echo L('_WEBSITE_NAME_');?></title>
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <a href="javascript:void(0);" class="btn disabled">广告列表</a>
                                <a href="<?php echo U('Ads/add');?>" class="btn btn-primary">添加广告</a>
                             </span>
                        </header>
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" method="post" action="<?php echo U('Ads/listorder');?>">
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped" id="dynamic-table">
                                    <thead>
                                    <tr>
                                        <th class="col-lg-3">广告名称</th>
                                        <th class="col-lg-3">广告位置</th>
                                        <th class="col-lg-1">媒介类型</th>
                                        <th class="col-lg-1">开始日期</th>
                                        <th class="col-lg-1">结束日志</th>
                                        <th class="col-lg-1">点击次数</th>
                                    ...
                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td>
                                            <a href='<?php echo U("Ads/edit/id/$vo[ad_id]");?>' class="edit">修改</a> |
                                            <a href="javascript:confirmurl('<?php echo U('/Ads/del',array('id'=>$vo['ad_id']));?>', '是否删除?')" class="delete">删除</a>
