...
class UcenterController extends CommonController {
    ...
    public function index()
    {
        ...
        $userinfo1 = M('students')->where(['student_id'=>$student_id])->find();
        ...
        if($userinfo1['school_id'] < 19 && $userinfo1['school_id'] <> 2) {//旧收费模式
    ...
    public function setting()
    {
        ...
        //判断有没有交费
        $userinfo = M('students')->where(['student_id'=>$student_id])->find();
        ...
        if($userinfo['school_id'] < 19 && $userinfo['school_id'] <> 2) {//旧收费模式
            ...
            if(time() > $userinfo['paid_expires']){//未付费
                ...
                $end_time = $userinfo['paid_expires'];
            }
        }
    ...
    public function punch_handle()
    {
        ...
        $this->success("恭喜您,打卡成功！",U('mobile.php/Ucenter1/punchShare',array('student_id'=>$data['student_id'],'tan'=>1)));
    }
