...
Date.fullYearStart = "20"; (function() {
    ...
    d.fn.extend({
        renderCalendar: function(t) {
            ...
            while (n++<q) {
                ...
                for (var x = 0; x < 7; x++) {
                    var j = m.getMonth() == B;  // mymy
                    var y = d(C("td")).html("<div class=\"td_td \" da=\""+m+"\"><span>"+m.getDate() + ""+"</span></div>").addClass((j ? "current-month ": "other-month ") + (m.isWeekend() ? "weekend ": "weekday ") + (j && m.getTime() == z.getTime() ? "today ": "")).data("datePickerDate", m.asString()).hover(A(k), g);
        ...
        datePicker: function(e) {
            ...
            return this.each(function() {
                ...
                f.init(e);
                if (!i && e.createButton) {
                    f.button = d('<a href="#" class="dp-choose-date" title="' + d.dpText.TEXT_CHOOSE_DATE + '">' + d.dpText.TEXT_CHOOSE_DATE + "</a>").bind("click",
                    function() {
                        g.dpDisplay(this);
                        this.blur();
                        return false
    ...
    d.extend(a.prototype, {
        ...
        display: function(e) {
            ...
            n.append(d("<div></div>").attr(o).css(j).append(d("<div class=dp-head><h2></h2></div>"), d('<div class="dp-nav-prev"></div>').append(d('<a id="dp-nav-prev-year" href="#" title="' + d.dpText.TEXT_PREV_YEAR + '">&laquo;</a>').bind("click",
            function() {
                return m._displayNewMonth.call(m, this, 0, -1)
            }), d('<a id="dp-nav-prev-month" href="#" title="' + d.dpText.TEXT_PREV_MONTH + '">&lt;</a>').bind("click",
            function() {

                return m._displayNewMonth.call(m, this, -1, 0)
            })), d('<div class="dp-nav-next"></div>').append(d('<a id="dp-nav-next-year" href="#" title="' + d.dpText.TEXT_NEXT_YEAR + '">&raquo;</a>').bind("click",
            function() {
                return m._displayNewMonth.call(m, this, 0, 1)
            }), d('<a id="dp-nav-next-month" href="#" title="' + d.dpText.TEXT_NEXT_MONTH + '">&gt;</a>').bind("click",
            function() {
            ...
            if (this.displayClose) {
                f.append(d('<a href="#" id="dp-close">' + d.dpText.TEXT_CLOSE + "</a>").bind("click",
                function() {
                    m._closeCalendar();
                    return false
                }))
        ...
        _displayNewMonth: function(f, e, g) {
            if (!d(f).is(".disabled")) {
                ...
                getM(this.displayedYear,this.displayedMonth+1);
            }
            f.blur();
            return false
        },
        ...
        _renderCalendar: function() {
            ...
            d(".dp-calendar", this.context).renderCalendar(d.extend({},
            this.settings, {
