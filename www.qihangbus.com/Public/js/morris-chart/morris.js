(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype.gridDefaults = {
      ...
      goals: [],
      goalStrokeWidth: 1.0,
      goalLineColors: ['#666633', '#999966', '#cc6666', '#663333', '#FFFF00'],
      events: [],
      eventStrokeWidth: 1.0,
      eventLineColors: ['#005a04', '#ccffbb', '#3a5f0b', '#005502', '#FFFF00']
    };
  ...
  Morris.Bar = (function(_super) {
    ...
    Bar.prototype.drawBar = function(xPos, yPos, width, height, barColor) {
      return this.raphael.rect(xPos, yPos, width, height).attr('fill', '#aee078').attr('stroke-width', 0);
    };
