			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" id="validation-form" method="post" action="<?php echo U('menuAdd');?>" novalidate="novalidate">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												<select name="pid"  class="col-sm-3" >
														<option>--无--</option>
													<?php if(is_array($first_level)): foreach($first_level as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
												</select>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												<input name="name" type="text" class="col-xs-10 col-sm-6"/>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												<input name="url" type="text" class="col-xs-10 col-sm-6"/>
											</div>
										</div>
										<span class="col-sm-3"></span>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												<input name="sort" type="text" value="50" class="col-xs-10 col-sm-6"/>
											</div>
										</div>
									</div>
									<div class="space-2"></div>
