				...
				<div class="main-content-inner">
					<div class="page-content">
							<div class="row">
							    <div class="col-xs-12">
										<div>
											<form id="menuOrder" name="menuOrder" method="post" action="<?php echo U('menuOrder');?>" >
                                                ...
                                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="<?php echo U('menuEdit',array('id'=>$v['id']));?>" title="修改">
...
<script type="text/javascript">
	$('.red').click(function(){
		...
		layer.alert('确定要删除吗?',{icon:3,title:'提示'},function(index){
			...
			$.get("<?php echo U('menuDel');?>?id="+id, function (data) {
				if(data.status == 1){
