	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<a href="/database/excel/绘本替换模板.xlsx">
						...
						<form class="form-horizontal" id="dir-replace" method="post"	 enctype="multipart/form-data">
							<div class="form-group">
								<label class="col-sm-2  control-label no-padding-right" > 添加替换绘本目录表格： </label>
...
<script>
	...
	$(function(){
		...
		$('#dir-replace').submit(function(){
			return test($('input[name=dir_replace]'),'请上传替换目录数据','file');
		});
