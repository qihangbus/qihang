                        ...
                        <form name="admin_list_sea" class="form-search" method="get">
                            <div class="input-group col-xs-12">
                                ...
                                <div class="col-xs-5">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn inline">
                                        <a href="/default.php/Admin/School/grade">
                                ...
                                <form>
                                    ...
                                    <form>
                                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                                <td class="center">
                                                    <label class="pos-rel">
                                                        <input name='left_id[]' class="ace"  type='checkbox' value='<?php echo ($v["grade_id"]); ?>'>
                                                        <span class="lbl"> </span>
                                                    </label>
                                                </td>
                                                <td><?php echo ($v["school_name"]); ?></td>
                                                <td><a href="<?php echo U('sclass',['grade_id'=>$v['grade_id']]);?>"><?php echo ($v["grade_name"]); ?></a></td>
                                                <td>
                                                    <div class="action-buttons">
                                                        <a class="green" href="<?php echo U('gradeEdit',array('id'=>$v['grade_id']));?>" title="编辑">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>
                                                        <a class="red" href="javascript:void(0);" data-id="<?php echo ($v["grade_id"]); ?>" title="删除">
