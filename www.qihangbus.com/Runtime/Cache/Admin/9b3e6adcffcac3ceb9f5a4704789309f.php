    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="base" method="post" action="<?php echo U('liveSave');?>">

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 专家讲堂： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="live_zj" value="<?php echo C('live_zj');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 老师培训： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="live_ls" value="<?php echo C('live_ls');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 代理培训： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="live_dl" value="<?php echo C('live_dl');?>" type="text"/>
                                </div>
                            </div>
