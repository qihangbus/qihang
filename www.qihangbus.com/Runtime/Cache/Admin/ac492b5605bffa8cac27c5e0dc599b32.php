							    ...
							    <div class="col-xs-12">
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($article)): foreach($article as $key=>$v): ?><tr>
														<td align="center">
															<label class="pos-rel">
																<input name='id[]' id="navid" class="ace real"  type='checkbox' value='<?php echo ($v["id"]); ?>'>
															<span class="lbl"></span>
															</label>
														</td>
														<td align="center"><?php echo ($v["id"]); ?></td>
														<td><a href="javascript:void(0)" target="_blank" title="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></a></td>
														<td><?php echo ($v["column_name"]); ?></td>
														<td><?php echo (date('Y-m-d',$v["addtime"])); ?></td>
														<td>
															<div class="action-buttons">
																<a class="green" href="<?php echo U('Article/edit',array('id'=>$v['id']));?>" title="修改">
