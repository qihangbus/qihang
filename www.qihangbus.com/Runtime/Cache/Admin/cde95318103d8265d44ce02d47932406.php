                ...
                <div class="page-header">
                    <h1>
                        ...
                        <small>
                            ...
                            修改<strong>网站设置</strong>信息
                        </small>
                    </h1>
                </div>
<style type="text/css">
    .row .profile-info-row{line-height: 2.5}
    .row .profile-info-row input{padding:0 0;width: 80%}
</style>

                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="base" method="post" action="<?php echo U('siteSave');?>">

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 平台名称： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_name" value="<?php echo C('site_name');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 平台标题： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_title" value="<?php echo C('site_title');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 平台描述： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_des" value="<?php echo C('site_des');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 平台关键字： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_keywords" value="<?php echo C('site_keywords');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 客服QQ： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_qq" value="<?php echo C('site_qq');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 客服电话： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_tel" value="<?php echo C('site_tel');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 招商电话： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_join" value="<?php echo C('site_join');?>" type="text"/>
                                </div>
                            </div>

                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"> 地点： </label>
                                <div class="col-sm-10" >
                                    <input class="col-sm-3" name="site_addr" value="<?php echo C('site_addr');?>" type="text"/>
                                </div>
                            </div>
