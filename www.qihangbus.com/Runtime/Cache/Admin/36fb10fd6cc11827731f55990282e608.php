                        ...
                        <div>
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                            ...
                                            <td><span><?php echo ($v["name"]); ?></span> <strong>(ID：<?php echo ($v["id"]); ?>)</strong></td>
                                            <td><?php echo (date('Y-m-d',$v["addtime"])); ?></td>
                                            <td><input name="<?php echo ($v["c_id"]); ?>" value=" <?php echo ($v["sort"]); ?>" class="list_order"/></td>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">

                                                    <a class="green" href="<?php echo U('bannerEdit',array('id'=>$v['id']));?>" title="修改">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="javascript:;" data-id="<?php echo ($v["id"]); ?>" title="删除">
