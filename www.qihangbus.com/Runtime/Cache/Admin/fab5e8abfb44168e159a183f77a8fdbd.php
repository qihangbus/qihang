                ...
                <div class="row maintop">
                        ...
                        <form name="admin_list_sea" class="form-search" method="get">
                            <div class="input-group col-xs-12">
                                ...
                                <div class="col-xs-5">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn inline">
                                        <a href="/default.php/Admin/Book/index">
                    ...
                    <div class="col-xs-2">
                        <div class="input-group-btn">
                            <a href="/default.php/Admin/Book/outExcel">
                        ...
                        <div>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                        <td class="center">
                                            <label class="pos-rel">
                                                <input name='left_id[]' class="ace"  type='checkbox' value='<?php echo ($v["book_id"]); ?>'>
                                                <span class="lbl"> </span>
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <?php if(($v['class_2']) == "1"): ?>小班<?php endif; ?>
                                            <?php if(($v['class_3']) == "1"): ?>中班<?php endif; ?>
                                            <?php if(($v['class_4']) == "1"): ?>大班<?php endif; ?>
                                        </td>
                                        <td><?php echo ($v["sort"]); ?></td>
                                        <td>
                                            <div class="action-buttons">
                                                <a class="green" href="<?php echo U('edit',array('id'=>$v['book_id']));?>" title="编辑">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
                                                <a class="red" href="javascript:void(0);" data-id="<?php echo ($v["book_id"]); ?>" title="删除">
