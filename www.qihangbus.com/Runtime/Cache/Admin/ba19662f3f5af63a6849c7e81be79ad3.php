					...
					<div class="col-xs-12">
						<form class="form-horizontal" name="add" id="add" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="grade_id"  class="col-sm-3" >
										<?php if(is_array($grade)): foreach($grade as $key=>$v): ?><option value="<?php echo ($v["grade_id"]); ?>" <?php if(($v["grade_id"]) == $data['grade_id']): ?>selected<?php endif; ?> ><?php echo ($v["grade_name"]); ?></option><?php endforeach; endif; ?>
									</select>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right"> 班级名称：  </label>
								<div class="col-sm-10">
									<select name="class_id"  class="col-sm-3" >
										<?php if(is_array($class)): foreach($class as $key=>$v): ?><option value="<?php echo ($v["class_id"]); ?>" <?php if(($v["class_id"]) == $data['class_id']): ?>selected<?php endif; ?> ><?php echo ($v["class_name"]); ?></option><?php endforeach; endif; ?>
									</select>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="student_name" value="<?php echo ($data["student_name"]); ?>"/>
								</div>
							</div>
							<div class="space-4"></div>

							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right"> 家长姓名：  </label>
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="parent_name" value="<?php echo ($parent["parent_name"]); ?>"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="parent_mobile" value="<?php echo ($parent["parent_mobile"]); ?>"/>
								</div>
							</div>
							<div class="space-4"></div>
...
<script type="text/javascript">
	$(function(){
		...
		$('select[name="grade_id"]').change(function(){
			var id = $(this).val();
			$.get("/default.php/Admin/User/selectClass/id/"+id,function(data,status){
				if(data.status == 1){
					var option = '<option value="">-请选择班级-</option>';
					$.each(data.info,function(){
						option += '<option value="'+this.class_id+'">'+this.class_name+'</option>'
					});
