					...
					<div class="col-xs-12">
						<form class="form-horizontal" name="add" id="add" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="admin_name" value="<?php echo ($data["admin_name"]); ?>"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" maxlength="11" name="admin_mobile" value="<?php echo ($data["admin_mobile"]); ?>"/>
								</div>
							</div>
							<div class="space-4"></div>
