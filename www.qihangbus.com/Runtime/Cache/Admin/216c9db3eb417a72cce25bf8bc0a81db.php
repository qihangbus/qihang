                ...
                <div class="row maintop">
                        ...
                        <form name="admin_list_sea" class="form-search" method="get">
                            <div class="input-group col-xs-12">
                                <div class="col-xs-7" style="padding-left:1px;position: relative;display: table;border-collapse: separate;">
                                    ...
                                    <input name="value" value="<?php echo ($value); ?>" type="text" class="admin_sea col-xs-3" style="margin-right:5px" placeholder="输入产品名称">
                                    <div class="input-daterange">
                                        <input type="text" value="<?php echo ($start); ?>" class="admin_sea col-xs-3 daterange" name="start" placeholder="开始时间">
                                         <span class="col-xs-1" style="width:37px;margin-top:4px;"><i class="ace-icon fa fa-exchange"></i></span>
                                        <input type="text" value="<?php echo ($end); ?>" class="admin_sea col-xs-3 daterange" name="end" placeholder="结束时间">
                                    </div>
                                </div>
                                <div class="col-xs-5">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn inline">
                                        <a href="/default.php/Admin/Stock/out">
                    ...
                    <div class="col-xs-2">
                        <div class="input-group-btn">
                            <a href="<?php echo U('outOutExcel',['value'=>$value,'start'=>$start,'end'=>$end]);?>">
                        ...
                        <div>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                        <td class="center">
                                            <label class="pos-rel">
                                                <input name='left_id[]' class="ace"  type='checkbox' value='<?php echo ($v["id"]); ?>'>
                                                <span class="lbl"> <?php echo ($v["id"]); ?></span>
                                            </label>
                                        </td>
                                        <td><?php echo ($v["name"]); ?></td>
                                        <td><?php echo ($v["num"]); ?></td>
                                        <td><?php if(!empty($v["addtime"])): echo (date('Y-m-d',$v["addtime"])); endif; ?></td>
                                        <td>
                                            <div class="action-buttons">
                                                <a class="green" href="<?php echo U('outDetail',array('id'=>$v['id']));?>" title="详情">
                                                    <i class="ace-icon fa fa-search-plus bigger-130"></i>																</a>
                                                <a class="red" href="javascript:void(0);" data-id="<?php echo ($v["id"]); ?>" title="删除">
