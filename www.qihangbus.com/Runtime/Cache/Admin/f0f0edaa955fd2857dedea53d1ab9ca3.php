...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="/Public/2017/assets/css/ace.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/Public/2017/assets/css/ace-part2.css" />
		<![endif]-->
		<link rel="stylesheet" href="/Public/2017/assets/css/ace-rtl.css" />
...
<style>
	...
	<div class="login-container">
			...
			<div id="login-box" class="login-box visible widget-box no-border">
				<div class="widget-body">
					<div class="widget-main">
						...
						<form name="runlogin" id="runlogin" method="post">
							<fieldset>
								<label class="block clearfix">
									<span class="block input-icon input-icon-right">
										<input type="text" class="form-control" name="username" id="admin_username" placeholder="用户名" />
								...
								<label class="block clearfix">
									<span class="block input-icon input-icon-right">
										<input type="password" class="form-control" name="pwd" id="admin_pwd" placeholder="输入密码" />
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/Public/2017/assets/js/jquery.js'>"+"<"+"/script>");
		</script>
		<!-- <![endif]-->
