					...
					<div class="col-xs-12">
						<form class="form-horizontal" name="add" id="add" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="province_id"  class="col-sm-2" required>
										...
										<?php if(is_array($province)): foreach($province as $key=>$v): ?><option value="<?php echo ($v["region_id"]); ?>" <?php if(($v["region_name"]) == $data['province']): ?>selected<?php endif; ?> ><?php echo ($v["region_name"]); ?></option><?php endforeach; endif; ?>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input name="name" type="text" class="col-sm-3" value="<?php echo ($data["name"]); ?>" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input name="mobile" type="text" minlength="11" maxlength="11" class="col-sm-3" value="<?php echo ($data["mobile"]); ?>" required>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right"> 员工手机号：  </label>
								<div class="col-sm-10">
									<input name="mobile2" type="text" minlength="11" maxlength="11" class="col-sm-3" value="<?php echo ($data["mobile2"]); ?>">
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input name="bank_card" type="text" class="col-sm-3" value="<?php echo ($data["bank_card"]); ?>">
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input name="bank_name" type="text" class="col-sm-3" value="<?php echo ($data["bank_name"]); ?>">
								</div>
							</div>
							<div class="space-4"></div>
