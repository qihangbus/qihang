                        ...
                        <form name="admin_list_sea" class="form-search" method="get">
                            <div class="input-group col-xs-12">
                                ...
                                <div class="col-xs-5">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn inline">
                                        <a href="/default.php/Admin/User/agent">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a class="light-orange" href="javascript:void(0);" data-id="<?php echo ($v['id']); ?>" title="发送消息">
                                                    <i class="ace-icon fa fa-envelope-o bigger-130"></i>
                                                </a>
                                                <a class="green" href="<?php echo U('aEdit',['id'=>$v['id']]);?>" title="编辑">
