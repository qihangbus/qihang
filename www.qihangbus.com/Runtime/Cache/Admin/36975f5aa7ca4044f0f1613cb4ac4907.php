                        ...
                        <form name="admin_list_sea" class="form-search" method="get">
                            <div class="input-group col-xs-12">
                                <div class="col-xs-7" style="padding-left:1px;position: relative;display: table;border-collapse: separate;">
                                    ...
                                    <input name="value" value="<?php echo ($value); ?>" type="text" class="admin_sea col-xs-8" style="margin-right:5px" placeholder="输入教师姓名">
                                </div>
                                <div class="col-xs-5">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn inline">
                                        <a href="/default.php/Admin/User/teacher">
                        ...
                        <div>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                        <td class="center">
                                            <label class="pos-rel">
                                                <input name='left_id[]' class="ace"  type='checkbox' value='<?php echo ($v["teacher_id"]); ?>'>
                                                <span class="lbl"> </span>
                                            </label>
                                        </td>
                                        <td><?php echo ($v["teacher_name"]); ?></td>
                                        <td><?php echo ($v["teacher_mobile"]); ?></td>
                                        <td><?php echo ($v["school_name"]); ?></td>
                                        <td><?php echo ($v["grade_name"]); ?></td>
                                        <td><?php echo ($v["class_name"]); ?></td>
                                        <td>
                                            <div class="action-buttons">
                                                <a class="light-orange" href="javascript:void(0);" data-id="<?php echo ($v['teacher_id']); ?>" title="发送消息">
                                                    <i class="ace-icon fa fa-envelope-o bigger-130"></i>
                                                </a>
                                                <a class="green" href="<?php echo U('tEdit',array('id'=>$v['teacher_id']));?>" title="编辑">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:void(0);" data-id="<?php echo ($v["teacher_id"]); ?>" title="删除">
