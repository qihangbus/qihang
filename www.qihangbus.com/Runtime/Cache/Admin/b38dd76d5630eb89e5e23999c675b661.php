                        ...
                        <form name="admin_list_sea" class="form-search" method="get">
                            <div class="input-group col-xs-12">
                                <div class="col-xs-7" style="padding-left:1px;position: relative;display: table;border-collapse: separate;">
                                    ...
                                    <input name="value" value="<?php echo ($value); ?>" type="text" class="admin_sea col-xs-3" style="margin-right:5px" placeholder="输入学校名称">
                                </div>
                                <div class="col-xs-5">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn inline">
                                        <a href="/default.php/Admin/School/sclass">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                <form>
                                    ...
                                    <tr>
                                        ...
                                        <th>订购人数</th>
                                        <th>订购率</th>
                                        <th class="hidden-xs" style="border-right:#CCC solid 1px;">操作</th>
                                    </tr>
                                    </thead>
                                    <form>
                                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                                <td class="center hidden-xs">
                                                    <label class="pos-rel">
                                                        <input name='left_id[]' class="ace"  type='checkbox' value='<?php echo ($v["class_id"]); ?>'>
                                                        <span class="lbl"> </span>
                                                    </label>
                                                </td>
                                                <td><?php echo ($v["school_name"]); ?></td>
                                                <td><?php echo ($v["grade_name"]); ?></td>
                                                <td><a href="<?php echo U('User/student',['class_id'=>$v['class_id']]);?>"><?php echo ($v["class_name"]); ?></a></td>
                                                <td><?php echo ($v["stu_num"]); ?></td>
                                                <td><?php echo ($v["reg_stu"]); ?></td>
                                                <td><?php echo ($v["pay_stu"]); ?></td>
                                                <td><?php echo ($v["pay_percent"]); ?>%</td>
                                                <td class="hidden-xs">
                                                    <div class="action-buttons">
                                                        <a class="green" href="<?php echo U('classEdit',array('id'=>$v['class_id']));?>" title="编辑">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>
                                                        <a class="red" href="javascript:void(0);" data-id="<?php echo ($v["class_id"]); ?>" title="删除">
