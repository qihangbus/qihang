					...
					<div class="col-xs-12">
						<form class="form-horizontal" name="school-edit" id="school-edit" method="post">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="school_name" class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="school_leader" class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="leader_mobile" class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="school_teacher" class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right"> 手机号：  </label>
								<div class="col-sm-10">
									<input type="text" name="teacher_mobile" class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="agent_mobile" class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<select name="city_id"  class="col-sm-2" >
										...
										<?php if(is_array($city)): foreach($city as $key=>$v): ?><option value="<?php echo ($v["region_id"]); ?>"><?php echo ($v["region_name"]); ?></option><?php endforeach; endif; ?>

									</select>
									<select name="district_id"  class="col-sm-2" >
										<option value="">-请选择区县-</option>
										<?php if(is_array($zone)): foreach($zone as $key=>$v): ?><option value="<?php echo ($v["region_id"]); ?>"><?php echo ($v["region_name"]); ?></option><?php endforeach; endif; ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="school_address"  class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" name="school_num"  class="col-xs-10 col-sm-6"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="meal_type"  class="col-sm-3" >
										...
										<option value="1">一周两本</option>
										<option value="2">一周四本</option>
									</select>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label no-padding-right"> 市场价(元/月)：  </label>
								<div class="col-sm-10">
									<input type="number" name="meal_market_price"  class="col-xs-10 col-sm-3"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" name="class_max_num"  class="col-xs-10 col-sm-3"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="datetime" name="semester_one_start" class="col-xs-10 col-sm-3 daterange"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="datetime" name="semester_one"  class="col-xs-10 col-sm-3 daterange"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="datetime" name="semester_two_start"  class="col-xs-10 col-sm-3 daterange"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="datetime" name="semester_two"  class="col-xs-10 col-sm-3 daterange"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea class="col-sm-6" rows="3" name="school_desc" placeholder="50字以内" class="col-xs-10 col-sm-10" maxlength="50"/></textarea>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="radio">
										<label>
											<input name="charge_type" type="radio" class="ace" value="1" checked="checked">
											<span class="lbl"> 线上</span>
										</label>
										<label>
											<input name="charge_type" type="radio" class="ace" value="2">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="datetime" name="try_charge_time"  class="col-xs-10 col-sm-3 daterange"/>
								</div>
							</div>
							<div class="space-4"></div>
