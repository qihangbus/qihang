					...
					<div class="col-xs-12">
						<form class="form-horizontal" name="add" id="add" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="student_name"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="parent_name"/>
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="col-sm-3" type="text" name="parent_mobile"/>
								</div>
							</div>
							<div class="space-4"></div>
...
<script type="text/javascript">
	$(function(){
		...
		$('select[name="school_id"]').change(function(){
			var id = $(this).val();
			$.get("/default.php/Admin/School/selectGrade/id/"+id,function(data,status){
				if(data.status == 1){
					var option = '<option value="">-请选择年级-</option>';
					$.each(data.info,function(){
						option += '<option value="'+this.grade_id+'">'+this.grade_name+'</option>'
					});
					$('select[name="grade_id"]').html(option);
				}
			});
		});
