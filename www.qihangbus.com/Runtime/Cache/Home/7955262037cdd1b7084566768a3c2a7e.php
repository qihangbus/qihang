...
<head>
    ...
    <title><?php echo ($name); ?>_<?php echo C('site_title');?></title>
</head>
<body>
<div id="leftcontrol">
    <ul id="nav">
...
<div id="sitecontent" class="transform">
    ...
    <div class="scrollView">
        <div class="npagePage">
            <div class="content">
                <div id="newslist">
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="newstitem plr10 wow fadeIn" style="visibility: visible; animation-name: slideInLeft;">
                        <a class="newsinfo" href="<?php echo U('view',['id'=>$v['id']]);?>">
                            <div class="newsdate">
